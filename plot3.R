PowerConsum3<- read.table("household_power_consumption.txt", sep=";",nrows= 2075260, header=TRUE, quote= "", strip.white=TRUE, stringsAsFactors = FALSE, na.strings= "?")

sub<- subset(PowerConsum3, (PowerConsum3$Date == "1/2/2007" | PowerConsum3$Date== "2/2/2007")) 
